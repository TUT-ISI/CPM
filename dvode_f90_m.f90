...
!     INTEGER, PARAMETER, PRIVATE :: KFC = -3, KFH = -7, LENIV1 = 33,    &
      INTEGER, PARAMETER, PRIVATE :: IPCUTH_MAX = 100, KFC = -3,         &
        ...
        MAXCOR = 3, MAX_ARRAY_SIZE = 900000000, MSBP = 40, MXHNL0 = 10,  &
...
!_______________________________________________________________________
      ...
      REAL (WP), PARAMETER, PRIVATE :: THRESH = 1.4_WP  !sami 1.5
...
!write(*,*) 'come here4.2',Y(N)
        CALL DVSOL(WM,IWM,Y,IERSL)
        
!        write(*,*) 'come here4.5',Y(N)
        NNI = NNI + 1
        IF (IERSL>0) GOTO 60
...
!                   WM(I+J1) = (FTEM(I)-SAVF(I))*FAC
                   IF(J.NE.I.AND.J.LT.N-4.AND.I.LT.N-4) THEN 
                      WM(I+J1)=0.0
                   ELSE
                      WM(I+J1) = (FTEM(I)-SAVF(I))*FAC
                   ENDIF
!                   write(*,*) J,I,WM(I+J1),FTEM(I)
!                   pause
                 END DO
                 Y(J) = YJ
                 J1 = J1 + N
